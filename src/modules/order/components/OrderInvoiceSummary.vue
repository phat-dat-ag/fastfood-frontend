...
<template>
    <div class="space-y-3">
        <div v-for="orderDetail in props.order.orderDetails" :key="orderDetail.product.id"
            ...
            <div class="text-right">
                <p class="text-orange-600 font-semibold text-base">
                    {{ formatCurrencyVND((Number(orderDetail.discountedPrice) *
        ...
        <div class="space-y-3 border-t mt-4 pt-3 text-sm">
            ...
            <div v-if="props.order.originalPrice !== props.order.subtotalPrice"
                ...
                <span>Tổng cộng:</span>
                <span>{{ formatCurrencyVND(props.order.subtotalPrice) }}</span>
            </div>
            ...
            <div v-if="props.order.promotion" class="flex justify-between text-green-600">
                ...
                <span class="font-medium">
                    -{{ formatCurrencyVND((Number(props.order.subtotalPrice) -
                        (Number(props.order.totalPrice) -
